...
export default function ImportExpensesDialog({ open, onClose, onImport }: ImportExpensesDialogProps) {
  ...
  return (
    <Modal open={open} onClose={handleClose} title="Import Expenses" maxWidth="max-w-lg">
